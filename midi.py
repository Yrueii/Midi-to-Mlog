...
def manual():
    while True:
        ...
        midi_file = mido.MidiFile (midi_file.replace("\\", "/").replace('"', ''), print (midi_file))

        while True:
            location_x = input('X coord location (bottom left as origin) = ')
        ...
        while True:
            location_y = input('Y coord location (bottom left as origin) = ')
